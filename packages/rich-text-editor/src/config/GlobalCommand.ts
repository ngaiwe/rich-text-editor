...
// 点击事件超出内容区
export const CLICK_OUTSIDE_ROOT_COMMAND: LexicalCommand<boolean> =
  createCommand('CLICK_OUTSIDE_ROOT_COMMAND')
...
// 挖空 command
export const REPLACE_BLANK_COMMAND: LexicalCommand<undefined> = createCommand(
  'REPLACE_BLANK_COMMAND'
)
export const REPLACE_BLANK_CHANGE_COMMAND: LexicalCommand<undefined> =
  createCommand('REPLACE_BLANK_CHANGE_COMMAND')

// 插入表格 Command
export const EDU_INSERT_TABLE_COMMAND: LexicalCommand<TablePluginCommandType> =
  createCommand('EDU_INSERT_TABLE_COMMAND')
