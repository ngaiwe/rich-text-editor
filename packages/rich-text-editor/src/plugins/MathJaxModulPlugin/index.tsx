    ...
    try {
      ...
      domtoimage
        ...
        .then(async (blob: Blob) => {
          ...
          formdata.append('images', blob, `mathJax-${Date.now().toString(16)}.png`);
          ...
          editor.dispatchCommand(nodeKey ? REPLACW_IMAGE_COMMAND : INSERT_IMAGE_COMMAND, {
            src: fullUrl || '',
            width: width || 0,
            height: height || 0,
  ...
  return (
    ...
    >
      <Form
        ...
        onFinish={onFinish}
        onFinishFailed={error => message.error(`插入公式失败: ${JSON.stringify(error)}`)}
