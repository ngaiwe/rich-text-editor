...
const FormatPainterTool = () => {
  ...
  const touchButtonCallback = useCallback(
    (event: React.MouseEvent) => {
      ...
      editor.update((): void => {
        ...
        const sourceNode = selection.isBackward() ? focus?.getNode() : anchor?.getNode();

        const neareParagrapNode = $getNearestBlockElementAncestorOrThrow(focus?.getNode());
  ...
  }, [active, blockTyoe, editor, formateType, style, textFormate, updateBlockControl]);
