...
export type RegisterCommandType = (command: CommandType, listener: ListenerType) => () => void;
...
>((props, ref) => {
  ...
  useImperativeHandle(
    ...
    [commandsMap, dispatchCommandsMap],
  );

  return <>{props.children}</>;
});

EditorRefProxyContainer.displayName = 'EditorRefProxyContainer';
